...
export const getChampionInfo = async (championName: string) => {
    const url: URL = new URL(`http://ddragon.leagueoflegends.com/cdn/12.20.1/data/en_US/champion/${championName}.json`)
